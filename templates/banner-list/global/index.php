...
$this->add_render_attribute( 'main-container', 'data-item_selector', '.kitify-bannerlist__item' );

$this->add_render_attribute( 'list-container', 'class', 'kitify-bannerlist__list' );

if(!$enable_carousel){
    $this->add_render_attribute( 'list-container', 'class', 'col-row' );
}

$this->add_render_attribute( 'list-wrapper', 'class', 'kitify-bannerlist__list_wrapper');
...
if($enable_masonry){
    ...
    $masonry_attr = $this->get_masonry_options('.kitify-bannerlist__item', '.kitify-bannerlist__list');
}
else{
    if($enable_carousel){

...
?><div class="kitify-carousel kitify-carousel--simple<?php echo esc_attr($cols_class) ?>" data-slider_options="<?php echo htmlspecialchars( json_encode( $options ) ); ?>" dir="<?php echo $dir; ?>">

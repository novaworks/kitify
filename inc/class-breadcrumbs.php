...
if (!class_exists('Kitify_Breadcrumbs')) {
    ...
    class Kitify_Breadcrumbs
    {
        ...
        public function __construct($args = array())
        {
            ...
            $this->args = apply_filters('kitify_breadcrumbs/args', wp_parse_args($args, $defaults));
        ...
        public function get_trail()
        {
            ...
            $wrapper_classes = apply_filters('kitify_breadcrumbs/wrapper_classes', $wrapper_classes);
        ...
        public function get_items()
        {
            ...
            $breadcrumb = apply_filters('kitify_breadcrumbs/trail', $breadcrumb, $this->args);
        ...
        public function home_title()
        {
            ...
            $use_custom_title = apply_filters('kitify_breadcrumbs/custom_home_title', false);
        ...
        public function build_trail()
        {
            ...
            $custom_trail = apply_filters('kitify_breadcrumbs/custom_trail', false, $this->args);
             ...
             * @since 1.0.0
             */
            $this->items = apply_filters('kitify_breadcrumbs/items', $this->items, $this->args, $this);
        ...
        public function prepare_label($label, $fallback = false)
        {
            ...
            if (false !== $fallback) {
                $fallback = sprintf(
                    apply_filters('kitify_breadcrumbs/icon_fallback', '<span class="hidden">%s</span>', $fallback),
                    esc_attr($fallback)
                );
            }
            ...
            // Return default icon
            return sprintf(
                apply_filters('kitify_breadcrumbs/default_icon_format', '<span class="%1$s">%2$s</span>', $label, $fallback),

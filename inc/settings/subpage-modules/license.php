...
class License extends Page_Module_Base {
	...
	public function get_page_name() {
		return esc_html__( 'License', 'kitify' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['kitify-license'] = kitify()->plugin_path( 'templates/admin-templates/license.php' );

...
class Avaliable_Addons extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'kitify-avaliable-addons';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Widgets & Extensions', 'kitify' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['kitify-avaliable-addons'] = kitify()->plugin_path( 'templates/admin-templates/avaliable-addons.php' );

...
class Integrations extends Page_Module_Base {
	...
	public function get_page_slug() {
		return 'kitify-integrations-settings';
	}
	...
	public function get_page_name() {
		return esc_html__( 'Integrations', 'kitify' );
	}
	...
	public function page_templates( $templates = array(), $page = false, $subpage = false ) {
		...
		$templates['kitify-integrations-settings'] = kitify()->plugin_path( 'templates/admin-templates/integrations-settings.php' );

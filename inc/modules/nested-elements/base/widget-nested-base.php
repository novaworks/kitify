<?php
namespace KitifyThemeBuilder\Modules\NestedElements\Base;

if ( ! defined( 'ABSPATH' ) ) {
	exit; // Exit if accessed directly.
}

use Elementor\Kitify_Base;

/**
 * Used to create a new widget that can be nested inside other widgets.
 */
abstract class Widget_Nested_Base extends Kitify_Base {
	...
	protected function _get_default_child_type( array $element_data ) {
		return kitify()->elementor()->elements_manager->get_element_types( $element_data['elType'] );
	}

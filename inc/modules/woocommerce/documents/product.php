...
use KitifyThemeBuilder\Modules\ThemeBuilder\Documents\Single_Base;
...
class Product extends Single_Base {
	...
	public static function get_title() {
		return __( 'Single Product', 'kitify' );
	}

	public static function get_plural_title() {
		return __( 'Single Products', 'kitify' );
	}
	...
	public function get_depended_widget() {
		return kitify()->elementor()->widgets_manager->get_widget_types( 'kitify-wooproduct-datatabs' );
	}

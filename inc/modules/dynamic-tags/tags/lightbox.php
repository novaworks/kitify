...
class Lightbox extends Tag {
	...
	public function get_title() {
		return esc_html__( 'Lightbox', 'kitify' );
	}
	...
	private function get_image_settings( $settings ) {
		...
		if ( $image_id ) {
			$lightbox_image_attributes = kitify()->elementor()->images_manager->get_lightbox_image_attributes( $image_id );
	...
	public function render() {
		...
		// PHPCS - the method kitify()->elementor()->frontend->create_action_hash is safe.
		echo kitify()->elementor()->frontend->create_action_hash( 'lightbox', $value ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	}
}

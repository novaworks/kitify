...
class Post_Terms extends Tag {
	...
	protected function register_controls() {
		 ...
		 */
		$taxonomy_filter_args = apply_filters( 'kitify/dynamic_tags/post_terms/taxonomy_args', $taxonomy_filter_args );

		$taxonomies = kitify_helper()->get_taxonomies( $taxonomy_filter_args, 'objects' );

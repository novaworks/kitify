...
class Internal_URL extends Data_Tag {
	...
	public function get_title() {
		return esc_html__( 'Internal URL', 'kitify' );
	}
	...
	protected function register_controls() {
		$this->add_control( 'type', [
			...
			'options' => [
				'post' => esc_html__( 'Content', 'kitify' ),
				'taxonomy' => esc_html__( 'Taxonomy', 'kitify' ),
				'attachment' => esc_html__( 'Media', 'kitify' ),
				'author' => esc_html__( 'Author', 'kitify' ),
			],
		] );

		$this->add_control( 'post_id', [
			'label' => esc_html__( 'Search & Select', 'kitify' ),

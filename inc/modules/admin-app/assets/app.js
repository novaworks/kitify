  ...
  (0, _createClass2.default)(ConditionsProvider, [{
    ...
    value: function render() {
      if (this.state.action.current === ConditionsProvider.actions.FETCH_CONFIG) {
        if (this.state.error) {
          return /*#__PURE__*/_react.default.createElement("h3", null, __('Error:', 'kitify'), " ", this.state.error);
        }

        if (this.state.loading) {
          return /*#__PURE__*/_react.default.createElement("h3", null, __('Loading', 'kitify'), "...");
        }
      }
  ...
  (0, _createClass2.default)(ConditionsConfig, [{
    ...
    value: function calculateInstances(conditions) {
      ...
      if (0 === (0, _keys.default)(instances).length) {
        instances = [__('No instances', 'kitify')];
      }
    ...
    value: function render() {
      if (this.state.action.current === TemplatesProvider.actions.FETCH) {
        if (this.state.action.error) {
          return /*#__PURE__*/_react.default.createElement("h3", null, __('Error:', 'kitify'), " ", this.state.action.error);
        }
...
var SiteTemplateFooter = function SiteTemplateFooter(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.CardFooter, null, /*#__PURE__*/_react.default.createElement("div", {
    ...
    tag: "span",
    variant: "sm"
  }, /*#__PURE__*/_react.default.createElement("b", null, __('Instances', 'kitify'), ":")), /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    className: "e-site-template__instances-list",
    tag: "span",
    variant: "xxs"
  }, " ", instances), /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    text: __('Edit Conditions', 'kitify'),
...
function SiteTemplates(props) {
  ...
  if (!templates || !templates.length) {
    return /*#__PURE__*/_react.default.createElement("h3", null, __('No Templates found. Want to create one?', 'kitify'), "...");
  }
  ...
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    text: action.error,
    dismissButtonText: __('Go Back', 'kitify'),
    dismissButtonOnClick: resetActionState,
    approveButtonText: __('Learn More', 'kitify'),
...
function AddNew() {
  ...
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    variant: "h1"
  }, __('Start customizing every part of your site', 'kitify'))), /*#__PURE__*/_react.default.createElement(_siteEditor.SiteParts, {
...
function ConditionConflicts(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    ...
    variant: "sm"
  }, __('Elementor recognized that you have set this location for other templates: ', 'kitify'), " ", conflictLinks);
}
...
function Conditions(props) {
  ...
  if (!template) {
    return /*#__PURE__*/_react.default.createElement("div", null, __('Not Found', 'kitify'));
  }
  ...
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    variant: "h1",
    tag: "h1"
  }, __('Where Do You Want to Display Your Template?', 'kitify')), /*#__PURE__*/_react.default.createElement(_appUi.Text, {
    variant: "p"
  }, __('Set the conditions that determine where your template is used throughout your site.', 'kitify'), /*#__PURE__*/_react.default.createElement("br", null), __('For example, choose \'Entire Site\' to display the template across your site.', 'kitify'))), /*#__PURE__*/_react.default.createElement(_conditions.default, {
...
function Import() {
  ...
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    title: __('Your template was imported', 'kitify'),
    approveButtonText: __('Preview', 'kitify'),
    approveButtonUrl: importedTemplate.url,
    approveButtonTarget: "_blank",
    dismissButtonText: __('Edit', 'kitify'),
    ...
    heading: __('Import Template To Your Library', 'kitify'),
    text: __('Drag & Drop your .JSON or .zip template file', 'kitify'),
    secondaryText: __('or', 'kitify'),
    onFileSelect: upload,
...
function Templates() {
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    justify: "space-between",
    className: "page-header"
  }, /*#__PURE__*/_react.default.createElement("h1", null, __('Your Site\'s Global Parts', 'kitify')), /*#__PURE__*/_react.default.createElement(_appUi.AddNewButton, {
...
function DialogDelete(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    ...
    text: __('Are you sure you want to move this item to trash:', 'kitify') + " \"".concat(template.title, "\""),
...
function DialogRename(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.Dialog, {
    title: __('Rename Site Part', 'kitify'),
    approveButtonText: __('Change', 'kitify'),
    onSubmit: function onSubmit() {
      return closeDialog(true);
    },
    approveButtonOnClick: function approveButtonOnClick() {
...
function SiteEditor() {
  ...
  return /*#__PURE__*/_react.default.createElement(_appUi.ErrorBoundary, {
    title: __('Theme Builder could not be loaded', 'kitify'),
    ...
    text: __('Switch to table view', 'kitify'),
...
var Module = /*#__PURE__*/(0, _createClass2.default)(function Module() {
  ...
  elementorCommon.debug.addURLToWatch('kitify-pro/assets');

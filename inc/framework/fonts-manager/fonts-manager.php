...
if ( ! class_exists( 'CX_Fonts_Manager' ) ) {
	...
	class CX_Fonts_Manager {
		...
		function __construct( array $args = array() ) {
			...
			$this->fonts_host = apply_filters( 'kitify/fonts_manager/cdn_url', $this->fonts_host );
		...
		public function prepare_fonts() {
			...
			wp_enqueue_style( 'kitify-google-fonts-' . $this->args['prefix'], $font_url );
		}
		...
		public function transient_key() {
			return 'kitify_google_fonts_url_' . $this->args['prefix'];
		}
		...
		public function build_fonts_url() {
			 ...
			 */
			$this->fonts_data = apply_filters( 'kitify/fonts_manager/fonts_data', $this->fonts_data, $this->args );

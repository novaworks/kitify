...
class Group_Control_Box_Style extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['box_font_color'] = array(
			'label'     => esc_html__( 'Font Color', 'kitify' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => array(
		...
		$fields['box_size'] = array(
			'label'      => esc_html__( 'Box Size', 'kitify' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em', '%',
			),
		...
		$fields['box_height'] = array(
			'label'      => esc_html__( 'Box Height', 'kitify' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => array(
				'px', 'em', '%',
			),
		...
		$fields['box_border'] = array(
			'label'   => _x( 'Border Type', 'Border Control', 'kitify' ),
			'type'    => Controls_Manager::SELECT,
			'options' => array(
				''       => __( 'None', 'kitify' ),
				'solid'  => _x( 'Solid', 'Border Control', 'kitify' ),
				'double' => _x( 'Double', 'Border Control', 'kitify' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'kitify' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'kitify' ),
			),
			'selectors' => array(
		...
		$fields['box_border_width'] = array(
			'label'     => _x( 'Width', 'Border Control', 'kitify' ),
		...
		$fields['box_border_color'] = array(
			'label' => _x( 'Color', 'Border Control', 'kitify' ),
			'type' => Controls_Manager::COLOR,
			'default' => '',
			'selectors' => array(
		...
		$fields['allow_box_shadow'] = array(
			'label' => _x( 'Box Shadow', 'Box Shadow Control', 'kitify' ),
		...
		$fields['box_shadow_position'] = array(
			'label' => _x( 'Position', 'Box Shadow Control', 'kitify' ),
			'type' => Controls_Manager::SELECT,
			'options' => array(
				' '     => _x( 'Outline', 'Box Shadow Control', 'kitify' ),
				'inset' => _x( 'Inset', 'Box Shadow Control', 'kitify' ),
			),
			'condition' => array(
				'allow_box_shadow!' => '',
			),
        ...
        $fields['box_scale'] = array(
            'label'      => esc_html__( 'Box Scale', 'kitify' ),
            'type'       => Controls_Manager::SLIDER,
            'range'      => array(
                'px' => array(
                    'min' => 0,

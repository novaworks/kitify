...
/**
 * Class: Kitify_Archive_Title
 * Name: Archive Title
 * Slug: kitify-archive-title
 */
 ...
 * Post Title Widget
 */
class Kitify_Archive_Title extends Kitify_Base {
    ...
    public function get_name() {
        return 'kitify-archive-title';
    }

    protected function get_widget_title() {
        return esc_html__( 'Archive Title', 'kitify' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__( 'Post Title', 'kitify' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .kitify-archive-title' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .kitify-archive-title a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'typography',
                'selector' => '{{WRAPPER}} .kitify-archive-title',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .kitify-archive-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .kitify-archive-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        $this->add_control(
    ...
    protected function render() {
        ...
        if ( is_search() ) {
            $title = sprintf(
                '%1$s %2$s',
                '<span class="color-accent">' . __( 'Search Results for :', 'kitify' ) . '</span>',
        ...
        elseif ( is_front_page() && ! is_singular( 'page' ) ) {
            ...
            if ( get_bloginfo( 'description' ) ) {
                ...
                $title = esc_html__( 'Recent Posts', 'kitify' );
            }
        ...
        $html = sprintf( '<%1$s class="kitify-archive-title %2$s">', $settings['html_tag'], $animation_class );
        if ( $link ) {
    ...
    protected function content_template() {
        ...
        var html = '<' + settings.html_tag + ' class="kitify-archive-title ' + animation_class + '">';
        if ( link_url ) {
